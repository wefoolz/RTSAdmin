...
public class user_accept extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if(!userId.isEmpty())
                {
                    if(checkId(userId))
                    {
                        ...
                        Toast.makeText(user_accept.this,"Please Enter Valid id",Toast.LENGTH_SHORT).show();

                    }

                }else
                {
                    Toast.makeText(user_accept.this,"Please Provide Id",Toast.LENGTH_SHORT).show();
                }
    ...
    private class FetchDataTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                URL url = new URL("http://rtsregistration.in/php/rtsuserrequest.php");
            ...
            if (result != null) {
                try {
                    ...
                    if (result.startsWith("No results")) {
                        ...
                        Toast.makeText(user_accept.this, result, Toast.LENGTH_SHORT).show();
                    } else {
    ...
    void acceptUser(String id)
    {
        ...
        Request request = new Request.Builder()
                .url("http://rtsregistration.in/php/AcceptUser.php?id=" + id)
                .build();
        ...
        try {
            ...
            if (responseString.equalsIgnoreCase("User Accepted")) {
                Toast.makeText(user_accept.this, responseString, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(user_accept.this, "Error!" + e.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
