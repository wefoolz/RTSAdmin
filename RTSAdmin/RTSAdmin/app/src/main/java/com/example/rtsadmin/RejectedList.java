...
public class RejectedList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new RejectedList.FetchDataTask().execute();
    ...
    private class FetchDataTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                URL url = new URL("http://rtsregistration.in/php/rtsrejectedfetch.php");
            ...
            if (result != null) {
                try {
                    ...
                    if (result.startsWith("0 results")) {
                        ...
                        Toast.makeText(RejectedList.this, result, Toast.LENGTH_SHORT).show();
                    } else {
